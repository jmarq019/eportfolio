...
- **Vite** (v8) as the build tool and development server
...
The application is deployed on **Vercel** with automatic builds triggered on push to the main branch. Vite produces a static production build (`npm run build`) which Vercel serves from its global CDN.
